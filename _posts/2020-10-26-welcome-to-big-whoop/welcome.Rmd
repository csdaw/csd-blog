---
title: "Welcome to Big Whoop"
description: |
  Welcome to my new blog, Big Whoop. This is a sample post for
  me to test distill features and custom CSS.
author:
  - name: Charlotte Dawson
date: 10-26-2020
citation_url: https://big-whoop.netlify.app/posts/2020-10-26-welcome-to-big-whoop/
output:
...
```{r, echo=TRUE}
# This comment is 80 characters long aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa
library(ggplot2)
...
knitr::kable(list(d1, d2), caption = "A tale of two tables")
```
...
```{r}
knitr::kable(d2, format = "html", caption = "Title of the table")
```
